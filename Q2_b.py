...
#you can change k and iteration
k = 20
iteration = 200
eval = []
costs =[]
...
eval = np.array(eval)
print('If   k = ' , k, ' :')
print('Mean of evaluation is ', np.mean(eval), ' and variance of evaluation is ' , np.var(eval))
print('Mean of cost is ' , np.mean(costs), ' and variance of cost is ', np.var(costs))